...
load_model = tf.keras.models.load_model('/root/web/jamsu_model')
...
# 여기에 컬럼순서 변경 넣기
df = df[['rf_10184100', 'rf_10184110', 'rf_10184140', 'swl', 'inf', 'sfw', 'ecpc', 'tototf', 'tide_level', 'fw_1018662', 'fw_1018683', 'fw_1019630', 'wl_1018662', 'wl_1018683', 'wl_1019630', 'wl_1018680']]


if not os.path.exists('/root/web/scaler1_jamsu.pkl') or not os.path.exists('/root/web/scaler2_jamsu.pkl'):
    ...
    # 여기에 컬럼순서 변경 넣기
    total_csv = total_csv[['rf_10184100', 'rf_10184110', 'rf_10184140', 'swl', 'inf', 'sfw', 'ecpc', 'tototf', 'tide_level', 'fw_1018662', 'fw_1018683', 'fw_1019630', 'wl_1018662', 'wl_1018683', 'wl_1019630', 'wl_1018680']]


    mms1.fit(total_csv.iloc[:,:-1])
    mms2.fit(total_csv.iloc[:,-1:])
    pickle.dump(mms1, open('/root/web/scaler1_jamsu.pkl','wb'))
    pickle.dump(mms2, open('/root/web/scaler2_jamsu.pkl','wb'))
else:
    mms1 = pickle.load(open('/root/web/scaler1_jamsu.pkl','rb'))
    mms2 = pickle.load(open('/root/web/scaler2_jamsu.pkl','rb'))
...
new_content = ''
with open("/root/web/templates/dash_잠수교_form.html",'r', encoding='utf-8') as f:
    lines = f.readlines()
    for l in lines:
        new_content += l
...
with open("/root/web/templates/dash_잠수교.html", "w", encoding='utf-8') as f:
    f.write(new_content)
